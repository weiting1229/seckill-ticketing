...
| 3 | 獨立小型壓力測試腳本,量出單一 Redis 節點面對瞬間爆量的限流 CAS 檢查實際能撐多少併發(在 OCI 上測) | 🔧 **進行中**(因 §2.8 從階段 1 之後提前)。3-1、3-2 已跑(2026-09-23):**CAS 重試風暴坐實**(嘗試 ÷ 成功 ≈ 併發數),單 key 拐點在在途 10–20,30 起放行掉到 capacity 以下(報告 §14.4–14.5)。**下一步 3-3**:`BENCH_CAPACITY=100000000 sweep.sh 1 2 5 10 20` 量純 CAS 寫入上限。⚠️ 計畫 §5.1 公式待改寫(見 §4.3) |
